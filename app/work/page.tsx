...
statement of many of our priorities.
        ...
        <p className="text-gray-900 leading-relaxed mt-4">
          Nights and weekends, I can reliably be found in the <a href="/studio" className="underline hover:font-bold" style={{ color: 'var(--olive)' }}>ceramics studio</a>, exploring London's <a href="/galleries" className="underline hover:font-bold" style={{ color: 'var(--olive)' }}>galleries</a>, or sitting down to <a href="/reading" className="underline hover:font-bold" style={{ color: 'var(--olive)' }}>read</a>.
        </p>
      </section>
